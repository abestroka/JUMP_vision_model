...
def move_csv_files(repo_path):
    ...
    csv_dir = os.path.join(parent_dir, "csv_files_untreated")
...
# Example usage
move_csv_files("/eagle/projects/FoundEpidem/astroka/rpe/week_nine/ind_channels_seg_control/ch6/untreated")
