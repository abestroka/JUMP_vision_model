...
# results = model.train(data="/eagle/FoundEpidem/astroka/yolo/rpe_rad_tiles_9/data/dataset/", epochs=100, imgsz=640, batch=24, patience=10, name='rpe_rad_tiles_2', classes= ['0.001', '0.01', '0.1', '1.0', '2.0'])
