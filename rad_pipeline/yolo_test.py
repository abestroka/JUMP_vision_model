...
base_path = '/eagle/FoundEpidem/astroka/yolo/fib_control_seg_3/images'
...
# files = glob.glob('/eagle/FoundEpidem/astroka/yolo/fib_control_seg_1/images/**/*.png')
# print("NUM FILES")
# print(len(files))
# print(" ")
...
#         '/eagle/FoundEpidem/astroka/yolo/fib_control_seg_1/data/dataset/train'
#     )
    
# val_dir = prepare_classification_data(
#     np.array(files)[test_idx],
#     np.array(labels)[test_idx],
#     '/eagle/FoundEpidem/astroka/yolo/fib_control_seg_1/data/dataset/val'
# )
...
#     config_path = '/eagle/FoundEpidem/astroka/yolo/fib_control_seg_1/data/datasets/config.yaml'
#     )
