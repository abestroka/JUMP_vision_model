...
base_path = '/eagle/FoundEpidem/astroka/yolo/huvec_rad_seg_2/images/'
...
files = glob.glob('/eagle/FoundEpidem/astroka/yolo/huvec_rad_seg_2/images/**/*.png')
# print("NUM FILES")
# print(len(files))
# print(" ")
...
train_dir = prepare_classification_data(
        ...
        '/eagle/FoundEpidem/astroka/yolo/huvec_rad_seg_2/data/dataset/train'
    )
    
val_dir = prepare_classification_data(
    np.array(files)[test_idx],
    np.array(labels)[test_idx],
    '/eagle/FoundEpidem/astroka/yolo/huvec_rad_seg_2/data/dataset/val'
)
...
setup_classification_config(
    ...
    config_path = '/eagle/FoundEpidem/astroka/yolo/huvec_rad_seg_2/data/datasets/config.yaml'
    )
...
results = model.train(data="/eagle/FoundEpidem/astroka/yolo/huvec_rad_seg_2/data/dataset/", epochs=100, imgsz=640, batch=24, patience=10, name='huvec_rad_seg_2', classes= ['0.001', '0.01', '0.1', '1.0', '2.0', 'untreated'])
