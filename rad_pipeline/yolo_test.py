...
# files = glob.glob('/eagle/FoundEpidem/astroka/yolo/fib_control_seg_4/images/**/*.png')
# print("NUM FILES")
# print(len(files))
# print(" ")
...
#         '/eagle/FoundEpidem/astroka/yolo/fib_control_seg_4/data/dataset/train'
#     )
    
# val_dir = prepare_classification_data(
#     np.array(files)[test_idx],
#     np.array(labels)[test_idx],
#     '/eagle/FoundEpidem/astroka/yolo/fib_control_seg_4/data/dataset/val'
# )
...
#     config_path = '/eagle/FoundEpidem/astroka/yolo/fib_control_seg_4/data/datasets/config.yaml'
#     )
