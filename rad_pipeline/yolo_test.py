...
train_dir = prepare_classification_data(
        ...
        '/eagle/FoundEpidem/astroka/yolo/rpe_rad_whole_2/data/dataset/train'
    )
    
val_dir = prepare_classification_data(
    np.array(files)[test_idx],
    np.array(labels)[test_idx],
    '/eagle/FoundEpidem/astroka/yolo/rpe_rad_whole_2/data/dataset/val'
)
...
setup_classification_config(
    ...
    config_path = '/eagle/FoundEpidem/astroka/yolo/rpe_rad_whole_2/data/datasets/config.yaml'
    )
