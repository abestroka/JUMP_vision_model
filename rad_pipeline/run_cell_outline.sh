...
python ~/workspace/JUMP_vision_model/rad_pipeline/cell_outlines_w_stacking.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/fib_and_htert/week_one/results/mito_imgs/ --tmp_dir /dev/shm --num_workers 16 --projected_output_dir /eagle/projects/FoundEpidem/astroka/fib_and_htert/week_one/results/stacked_mito_imgs/
