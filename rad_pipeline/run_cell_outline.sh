...
plate="rpe_control"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe/week_six/20241206_Week5-6_RPE-1/20241205_OSU_HTSC_MW_ANL_CellPainting_RPE-1_W6C1__2024-12-06T07_18_44-Measurement1/Images"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cropped_cells.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe/week_six/rpe_control_seg --tmp_dir /dev/shm --num_workers 32
