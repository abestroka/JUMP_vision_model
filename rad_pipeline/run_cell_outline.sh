...
# plate="HUVEC_Control"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe_h2a/week_one/20250513_RPE-1_H2A_Week1/20250513_20x_ANL_CellPainting_RPE-1_Control_1__2025-05-13T15_05_43-Measurement1/Images"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cell_outlines.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe_h2a/week_one/results_seg/Control --tmp_dir /dev/shm --num_workers 16
