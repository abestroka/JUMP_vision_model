...
plate="rpe"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe_2/20x/20250208_20x_ANL_CellPainting_RPE-1_H2A_Test_b__2025-02-08T15_55_37-Measurement1/Images"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cell_outlines.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe_2/20x/results --tmp_dir /dev/shm --num_workers 32
