...
plate="rpe"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe_2/63x/20250207_63x_MW_ANL_CellPainting_RPE-1_H2A_Test__2025-02-07T15_36_28-Measurement1/Images"
# treatment_file="/home/astroka/workspace/JUMP_vision_model/rad_pipeline/week_five_rpe_layout.xlsx"
treatment_file="/home/astroka/workspace/JUMP_vision_model/rad_pipeline/etoposide_pilot_2.xlsx"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cell_outlines.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe_2/63x/results --tmp_dir /dev/shm --num_workers 16
