...
plate="rpe_control"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe/week_four/20241120_Weel4_RPE-1/20241119_OSU_HTSC_MW_ANL_CellPainting_RPE-1_W4C1__2024-11-19T18_10_06-Measurement1/Images"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cropped_cells.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe/week_four/results/rpe_control_seg --tmp_dir /dev/shm --num_workers 32
