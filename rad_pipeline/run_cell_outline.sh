...
# plate="HUVEC_Control"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe_h2a/week_four/20250604_RPE-1_H2A_Week4/20250603_20x_ANL_CellPainting_RPE-1_Plate8_1__2025-06-03T19_08_32-Measurement1/Images"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cell_outlines.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe_h2a/week_four/results_seg/Plate8 --tmp_dir /dev/shm --num_workers 16
