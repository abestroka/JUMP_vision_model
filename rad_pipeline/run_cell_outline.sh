...
# plate="HUVEC_Control"
# week='week_one'
images="/eagle/FoundEpidem/astroka/ten_week/week_one_corrected/20240718_Week1/20240717_OSU_HTSC_MW_ANL_CellPainting_P3_8stacks_1__2024-07-17T17_38_31-Measurement1/Images"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cell_outlines.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/ten_week/week_one_corrected/results/huvec_rad --tmp_dir /dev/shm --num_workers 16
