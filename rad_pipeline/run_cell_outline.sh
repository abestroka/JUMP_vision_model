...
python ~/workspace/JUMP_vision_model/rad_pipeline/cropped_cells_488_only.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/h2ax_2/ind_channels_seg/ch5 --tmp_dir /dev/shm --num_workers 32
