...
# plate="HUVEC_Control"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe_h2a/week_seven/20250625_RPE-1_H2A_Week7/20250624_20x_ANL_CellPainting_RPE-1_Control_1__2025-06-24T20_01_42-Measurement1/Images"
# treatment_file="/home/astroka/workspace/JUMP_vision_model/rad_pipeline/week_five_rpe_layout.xlsx"
treatment_file="/home/astroka/workspace/JUMP_vision_model/rad_pipeline/rpe_h2a_week3.xlsx"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cell_outlines.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe_h2a/week_seven/results_seg/Control --tmp_dir /dev/shm --num_workers 16
