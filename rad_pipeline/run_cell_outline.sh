...
plate="rpe"
# week='week_one'
images="/eagle/FoundEpidem/astroka/rpe_2/10x_air/20250208_10xAir_ANL_CellPainting_RPE-1_H2A_Test__2025-02-08T19_47_07-Measurement1/Images"
...
python ~/workspace/JUMP_vision_model/rad_pipeline/cropped_cells_488_only.py -i $images -p $plate -t $treatment_file -o /eagle/projects/FoundEpidem/astroka/rpe_2/10x_air/results_488_seg --tmp_dir /dev/shm --num_workers 32
