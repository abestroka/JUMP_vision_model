...
results = model.train(data="/eagle/FoundEpidem/astroka/yolo/fibroblast_123/data/dataset/", epochs=100, imgsz=640, batch=24, patience=10, name='fibroblast_1234', classes= ['week_1', 'week_2', 'week_3', 'week_4'])
