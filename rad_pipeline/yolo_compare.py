...
class_names = ['week_1', 'week_2', 'week_3']
...
results = model.train(data="/eagle/FoundEpidem/astroka/yolo/huvec_123/data/dataset/", epochs=100, imgsz=640, batch=24, patience=10, name='huvec_123', classes= ['week_1', 'week_2', 'week_3'])
