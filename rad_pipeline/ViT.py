...
#     print(len(val_ds))
    ...
    trainer = pl.Trainer(accelerator="gpu", devices=-1, precision=16, max_epochs=25)
...
def main():
    cells_path = '/eagle/projects/FoundEpidem/astroka/fib_and_htert/week_three/results_png_only/fib_control'
    ViT(cells_path)
